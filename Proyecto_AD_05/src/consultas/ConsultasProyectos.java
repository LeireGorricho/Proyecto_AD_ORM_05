...
public class ConsultasProyectos {
    ...
    public boolean anadirProyecto(String codigo, String nombre, String ciudad) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se ha podido añadir el proyecto, comprueba que el código no exista ya y que no se supere el máximo de longitud");
            return false;
        }
        return true;
    }
    ...
    public boolean editarProyecto(String codigo, String nombre, String ciudad, String estado) {
        ...
        try {
            ...
            JOptionPane.showMessageDialog(null, "No se ha podido editar el proyecto, comprueba que no se supere el máximo de longitud");
            return false;
        }
        return true;
    }
